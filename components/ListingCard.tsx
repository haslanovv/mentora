...
```
      ...
      {image ? (
        ...
        /* Şəkil yoxdursa boş sahə əvəzinə peşəkar placeholder */
        <div className="relative -mx-5 -mt-5 mb-5 h-36 overflow-hidden bg-[var(--surface-muted)]">
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="mb-2 grid h-12 w-12 place-items-center rounded-2xl border border-[var(--line)] bg-[var(--surface-solid)] shadow-sm">
              <svg
